...
export function EmptyState({
  ...
  return (
    <section 
      className="flex flex-col items-center justify-center p-8 sm:p-12 text-center rounded-xl border border-dashed border-border/60 bg-background/30 w-full min-h-[250px]"
      role="region"
